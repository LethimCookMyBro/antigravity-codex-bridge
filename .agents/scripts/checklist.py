...
Usage:
    python .agents/scripts/checklist.py .                    # Run core checks
    python .agents/scripts/checklist.py . --url <URL>        # Include performance checks
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python .agents/scripts/checklist.py .                      # Core checks only
  python .agents/scripts/checklist.py . --url http://localhost:3000  # Include performance
        """
    )
